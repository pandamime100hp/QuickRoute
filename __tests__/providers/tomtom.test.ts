import { Address } from "../../src/interfaces.js";
import { TomTom } from "../../src/providers/tomtom.js";
...
describe("validate API key", () => {
    ...
    test("API key should throw error if not set", () => {
        expect(() => new TomTom()).toThrow("TomTom API Key Not Found. Please set `TOMTOM_API_KEY` environment variable.");
    });
});
...
describe("TomTom search", () => {
    ...
    test("search should return mock data", async () => {
        const result: Address[] = await provider.search(TEST_QUERY);
